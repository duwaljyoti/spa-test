...
var update = __webpack_require__(15)("7eb98db2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-03030049\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Flash.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-03030049\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Flash.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Flash__ = __webpack_require__(13);
    ...
    _c("div", { staticClass: "container-fluid" }, [
      _vm.loggedUser
        ? _c("div", [
            ...
            _vm._v(" "),
            _c("ul", { staticClass: "nav navbar-nav" }, [
              _c("li", { class: { active: _vm.activeLink === "favourite" } }, [
                _c(
                  "a",
                  {
                    attrs: { href: "note#/?type=favourite" },
                    on: { click: _vm.changeNoteRoute }
                  },
                  [_vm._v("Favourite")]
                )
              ])
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(15)("4e71802c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3373ff55\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Loading.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3373ff55\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Loading.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api__ = __webpack_require__(52);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  getFavourite: function getFavourite(_ref2) {
    var commit = _ref2.commit;

    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */] + '?type=favourite').then(function (response) {
      commit('GET_FAVOURITE', response.data);
    }).catch();
  },
  save: function save(_ref3, note) {
    var commit = _ref3.commit;

    note.is_favourite = false;
    note.user_id = window.loggedUser.id;
    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */], note).then(function (response) {}).catch(function (err) {
      console.log(err);
    });
  },
  deleteNote: function deleteNote(_ref4, note) {
    var commit = _ref4.commit;

    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete(__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */] + '/' + note.id).then(function (resp) {
      return console.log(resp);
    });
  },
  toggleFavourite: function toggleFavourite(_ref5, id) {
    _objectDestructuringEmpty(_ref5);

    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(__WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */] + '/' + id + '/toggleFavourite', {
      is_favourite: true
    });
  },
  update: function update(_ref6, noteDetails) {
    var commit = _ref6.commit;

    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */] + '/' + noteDetails.noteId, noteDetails.updatedNote).then(function (resp) {
      return console.log(resp);
    });
  }
});
...
"use strict";
var RESOURCE_NOTE = 'api/notes';

/* harmony default export */ __webpack_exports__["a"] = (RESOURCE_NOTE);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_index__ = __webpack_require__(91);
...
var NoteApplication = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  router: router,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Note_vue__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Note_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Note_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Create_vue__ = __webpack_require__(88);
...
var routes = [{ path: '/', name: 'note', component: __WEBPACK_IMPORTED_MODULE_0__components_Note_vue___default.a }, { path: '/create', name: 'create', component: __WEBPACK_IMPORTED_MODULE_1__components_Create_vue___default.a }, { path: '*', redirect: '/' }];
...
Component.options.__file = "resources/assets/js/note/components/Note.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e3eef100", Component.options)
  } else {
    hotAPI.reload("data-v-e3eef100", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_NavBar__ = __webpack_require__(43);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _extends({
    toggleActiveClass: function toggleActiveClass(note) {
    ...
    getFavouriteId: function getFavouriteId() {
      ...
      if (this.loggedUser && this.loggedUser.id) {
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('api/users/' + this.loggedUser.id + '/getFavouriteNotesId').then(function (resp) {
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapActions */])(['getAll', 'getFavourite']), {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("nav-bar", {
        on: {
          "note-route-changed": function($event) {
            _vm.changeRoute("favourite")
          }
        }
      }),
      _vm._v(" "),
      _c("div", { attrs: { id: "notes-list" } }, [
        _c("div", { attrs: { id: "list-header" } }, [
          _c("h2", [_vm._v(_vm._s(_vm.noteTitle))])
        ]),
        _vm._v(" "),
                ...
                _vm._l(_vm.noteList, function(note) {
                  return _c(
                    "a",
                    {
                      ...
                      class: _vm.activeNote.id === note.id ? "active" : "",
                      attrs: { href: "#" }
                    },
                    [
                      _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e3eef100", module.exports)
  }
}
  ...
  methods: {
    save: function save() {
      ...
      this.$store.dispatch('save', this.note).then(function () {
        ...
        _this.$router.push({ path: 'note' });
      }).catch(function (err) {
        console.log(err);
      });
    }
  },
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapState */])(['notes'])),
  components: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__state__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutations__ = __webpack_require__(93);
...
"use strict";
var _GET$GET_FAVOURITE$SA;

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

/* harmony default export */ __webpack_exports__["a"] = (_GET$GET_FAVOURITE$SA = {}, _defineProperty(_GET$GET_FAVOURITE$SA, 'GET', function GET(state, notes) {
  state.notes = notes;
